...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifthenelse{\equal{\commandkey{eglise}}{oui}}{
\rubrica{Le célébrant se lève alors et dit :}
\traduire{%
Ut hanc ecclésiam, et altáre hoc, ad honórem tuum, et nomen Sancti tui \emph{\commandkey{Sanctus}}, purgare et bene{\x}\-dícere \pr{di}\ac{gné}ris, \terogamus}{%
Daignez purifier et bé\x{}nir cette église et cet autel, en votre honneur et au nom de saint \emph{\commandkey{Saint}}.
}
\rubrica{Puis l'on continue :}
}
