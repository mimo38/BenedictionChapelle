...
\makeindex
        ...
        \def\rubrum{\color{black}}%%%%%%%mettre"\def\rubrum{\color{rubrum}}" pour avoir le texte adéquat en rouge, et "\def\rubrum{\color{black}}" pour l'avoir en noir
        \def\nigra{\color{black}}
            \redlines
            \definecolor{gregoriocolor}{rgb}{0,0,0}%%%0,0,0 pour des lignes noires
        %
        %\let\red\rubrum
...
%%%%%%%%%%%%%% définir la lettrine des partitions
...
\maketitle
\thispagestyle{empty}
\pageblanche %%%% fait sauter une page
%\part{Bénédiction}

%\addcontentsline{toc}{chapter}{A l'extérieur}
\rubrica{Le début de la cérémonie est à l'extérieur de l'église (ou de l'oratoire) que l'on va bénir, lequel est vide et dépouillé de tout ornement.
Précédé de la croix et du clergé, l'officiant s'arrête devant la porte fermée de l'église, et dit cette oraison :}
...
\rubrica{Le célébrant asperge alors les murs extérieurs de l'église en commençant par le côté droit~; pendant ce temps, on chante le psaume \emph{Miserere}.}
\ps{50}
...
\medskip
\cantus{Antienne}{AspergesMeSolus}{Ant.}{7.}
\rubrica{De nouveau devant la porte, le célébrant dit alors :}
\flectamus
...
\Amen
\rubrique{La procession entre alors dans l'église au chant des litanies.}
\titre{Litanies des Saints}
\litanies[eglise=oui]{}
\medskip
\rubrica{Puis le célébrant dit~:}
\flectamus
...
\Amen
\rubrique{S'éloignant un peu de l'autel, le célébrant entonne :}
